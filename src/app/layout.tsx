...
export const metadata: Metadata = {
  title: "Mario Cards - Authentic Trading Card Collection",
  description: "Collect rare, holographic, and graded Mario trading cards. Premium authentic collectibles with certification for enthusiasts worldwide.",
  keywords: ["Mario cards", "trading cards", "collectibles", "rare cards", "holographic cards", "graded cards"],
  openGraph: {
    title: "Mario Cards - Premium Trading Card Collection",
    description: "Discover legendary Mario trading cards. Authentic, verified, and graded collectibles.",
    siteName: "Mario Cards",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Mario Cards - Authentic Trading Cards",
    description: "Collect legendary Mario cards. Premium authentic collectibles with certification."
  },
  robots: {
    index: true,
    follow: true
